...
> 本文档由 Claude Code 维护，随项目变更同步更新。最后更新：2026-09-07
...
**业务定位（智慧农场）**：本机规划为智慧农场子系统的**状态节点**——逐步接入各农业子系统（传感器采集 / 执行控制等），本机 OLED 作为**状态可视化层**，汇总展示各子系统是否工作正常。当前进度：**子系统① SHT30 温湿度、② GY-30 光照、③ MQ-2 可燃气体、④ 土壤湿度已接入**，读数/故障实时上屏（信息区 4 行已满员）。
