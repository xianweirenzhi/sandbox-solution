...
// 默认值按 3×1kΩ+1kΩ（4:1）分压 + 3V3 供电估算：满量程 3.3V→0.825V≈840 counts，
// 湿润 ~1.5V→0.375V≈380，过干 ~2.8V→0.70V≈715，取整留出滞回带。
#define SOIL_MOIST_BELOW 360   // 滤波值低于此值 → 判湿润适宜
#define SOIL_DRY_ABOVE   560   // 滤波值高于此值 → 判过干
