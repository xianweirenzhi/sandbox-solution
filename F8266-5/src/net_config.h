...
// ===================== F8266-5 网络配置（集中在此修改）=====================
// 设备统一命名 F8266-5：STA 主机名与配置热点名均取 NET_DEVICE_NAME。
...
#define NET_DEVICE_NAME        "F8266-5"
...
// ===================== 主机（esp32-1）TCP 通信参数 =====================
// 本从机(F8266-5)作为 TCP 客户端连主机 NET_HOST_IP:NET_HOST_PORT，连上即上报上线。
...
#define NET_HOST_PORT     8004             // 本从机(F8266-5)对应主机的监听端口
